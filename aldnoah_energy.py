...
DW7XL_PLAYABLES = OfficerEditorSchema(
    ...
    primary_section=BinaryRecordSectionSchema(
        ...
        section_subtitle="Mapped playable-officer fields from the DW7XL officer block.",
        columns=2,
...
DW8XL_PLAYABLES = OfficerEditorSchema(
    ...
    primary_section=BinaryRecordSectionSchema(
        ...
        toggle_subtitle="Untoggled writes 00 and toggled writes 01. These flags are not fully named yet.",
        toggle_columns=5,
    ),
...
WO3_PLAYABLES = OfficerEditorSchema(
    ...
    primary_section=BinaryRecordSectionSchema(
        ...
        section_subtitle="Mapped playable-officer fields from the shared WO3 officer block.",
        columns=2,
...
DW8XL_NPC = NpcEditorSchema(
    ...
    section=BinaryRecordSectionSchema(
        ...
        section_subtitle="Mapped DW8XL unit / NPC fields from the shared Pack_00 unit block.",
        columns=2,
